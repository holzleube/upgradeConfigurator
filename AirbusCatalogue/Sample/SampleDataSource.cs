...
namespace AirbusCatalogue.Sample
{
    ...
    public abstract class SampleDataCommon : BindableBase
    {
        ...
        public string Sub
        {
            ...
            set { this.SetProperty(ref this._Sub, value); }
        }
    ...
    public sealed class SampleDataSource
    {
        ...
        private ObservableCollection<BasicDataItem> _aircraftType = new ObservableCollection<BasicDataItem>();
        public ObservableCollection<BasicDataItem> AircraftType
        {
